...
```
Nome do produto: Lavô
Headline: "Cuidamos das suas roupas com carinho"
Subtítulo: "Um serviço simples, organizado e pensado para facilitar o seu dia"

Features:
Business
1. Cadastro de novo cliente
2. Visualizar informação do cliente
3. Entrar em contato com cliente por e-mail a partir de botão nas informações do cliente
4. Ver roupas em serviço na lavanderia
5. Poder marcar como serviço completo
6. Sinalizar cliente automaticamente quando o serviço foi completo
Client
1. Contratar serviço de lavagem (pontual ou assinatura)
2. Acompanhar andamento do serviço contratado (saber quando pode buscar roupas)


Limites por plano:
Limites por plano:
- PONTUAL: Hire a one time service
- WEEKLY: Take your load of clothes to wash every week
- BI-WEEKLY: Take your load of clothes to wash every two weeks
- MONTHLY: Take your load of clothes to wash once a month
...
- Quinzenal: R$ 10.50
- Mensal: R$ 11.00
O valor final dependerá dos itens selecionados e suas quantidades

Cores:
Text: 
- Primary: #354259 (dark blue) 
- Accent: #91DDCF (mint) 

Buttons: 
- Primary: #91DDCF (mint) 
- Secondary: #F19ED2 (pink) 
- Tertiary: #E8C5E5 (light pink) 

Background: 
- Base: white 
- Accents and Patterns: #F7F9F2 (light gray)
```
